...
@section('content')
    ...
    <section class="slider_wrap slider_fullscreen slider_alias_hpslider2">
        <div id="slider-2" class="flexslider">
            <ul class="slides">
                <li>
                    <img src="images/big_slider1_1.jpg" alt=""/>
                    <div class="slide_description_wrapper content_wrap">
                        <div class="slide_description">
                            <h1 class="slide_title">News demo</h1>
                            <h2 class="slide_subtitle">Embracing Performance<br>Driven Growth</h2>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="slide_description_wrapper content_wrap">
                        <div class="slide_description">
                            <h1 class="slide_title">News demo</h1>
                            <h2 class="slide_subtitle">Opening of New Branch<br>Office</h2>
                        </div>
                    </div>
                </li>
            </ul>
                        ...
                        <div class="swiper-slide" data-style="height:360px;" style="height:360px;">
                            <div title="New Ways Of Industry Grow Observed">
                                ...
                                <div class="sc_slider_info content-slide">
                                    ...
                                    <div class="sc_slider_reviews post_rating reviews_summary blog_reviews after_category">
                                    ...
                                    <div class="sc_section bg_tint_none" data-animation="animated fadeInUp normal"
                                        ...
                                        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                                            <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
                                                        ...
                                                        <aside class="widget_number_1 widget widget_recent_posts">
                                                            ...
                                                            <article class="post_item with_thumb first">
                                                                <div class="post_thumb">
                                                                    <img class="wp-post-image" width="75" height="75" alt="Aerospace &amp; Defense"
                                                ...
                                                <h3 class="sc_title sc_title_regular no_bottom_border" style="margin-top:2em;">Timeline</h3>
                                                ...
                                                <div id="sc_blogger_1894541376"
                                                    ...
                                                    <span class="post_info_item post_info_posted_by">by
                                                        <a href="#" class="post_info_author">root</a>
                                                                            ...
                                                                            <span class="post_info_item post_info_counters">Comments
                                            ...
                                            <div class="column-1_2 sc_column_item sc_column_item_2 even">
                                                <div id="sc_blogger_2130071380"
                                                    ...
                                                    <div class="post_item post_item_excerpt post_featured_default post_format_standard odd post-188 post type-post status-publish format-standard has-post-thumbnail hentry category-chemicals category-mining-industry category-sertification tag-news tag-people">
                                                        <div class="post_featured">
                                                            <div class="post_thumb"
                                                                ...
                                                                <a class="hover_icon hover_icon_link" href="#">
                                                                    <img class="wp-post-image" width="750" height="422" alt="We Need a Manufacturing Renaissance"
                                                        ...
                                                        <div class="post_content clearfix">
                                                            <h3 class="post_title">
                                                                <a href="#">
                                                                    <span class="post_icon icon-book-2"></span>We Need a Manufacturing Renaissance
                                                                </a>
                                                            </h3>
                                            ...
                                            <span class="post_info_item post_info_posted">Posted
                                                <a href="#" class="post_info_date">Jan 28, 2015</a>
                                                                ...
                                                                <a href="#" class="sc_button sc_button_square sc_button_style_button-2 sc_button_bg_link sc_button_size_medium add_link">
                                                                    <span class="button-up">More</span>
                                                                    <span>More</span>
                                                                </a>
                                                                <a href="#" class="sc_button sc_button_square sc_button_style_button-3 sc_button_bg_link sc_button_size_medium comments_button">
                                                    ...
                                                    <div class="post_item post_item_excerpt post_featured_default post_format_standard even last post-181 post type-post status-publish format-standard has-post-thumbnail hentry category-architecture category-electronics category-sertification category-uncategorized tag-architecture tag-business tag-design tag-engineering tag-identity tag-industry tag-motion tag-news tag-people tag-print">
                                                        ...
                                                        <div class="post_content clearfix">
                                                            <h3 class="post_title">
                                                                <a href="#">
                                                                    <span class="post_icon icon-book-2"></span>Governmental Control Over Industries
                                                                </a>
                                                            </h3>
                                        ...
                                        <div id="sc_blogger_1167910916"
                                            ...
                                            <span class="post_info_item post_info_posted">Posted
                                                <a href="#" class="post_info_date">Jan 28, 2015</a>
                                                                ...
                                                                <a href="#" class="sc_button sc_button_square sc_button_style_button-3 sc_button_bg_link sc_button_size_medium comments_button post">
                                                                    <span class="button-up">0</span>
                                                                    <span>0</span>
                                                                </a>
                                                            </div>
                            ...
                            <div class="vc_col-sm-12 wpb_column vc_column_container ">
                                <div class="wpb_wrapper">
                                    <div class="sc_section bg_tint_none" data-animation="animated fadeInUp normal"
                                        ...
                                        <h2 class="sc_title sc_title_regular sc_align_center no_bottom_border" style="text-align:center;">Top News</h2>

                                        <div id="sc_blogger_884375422" class="sc_blogger  layout_classic_3 template_masonry  sc_blogger_horizontal">
                                            <div class="isotope_wrap" data-columns="3">
                                                <div class="isotope_item isotope_item_classic isotope_item_classic_3 isotope_column_3">
                                                    <div class="post_item post_item_classic post_item_classic_3 post_format_standard odd">
